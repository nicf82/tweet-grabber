...
trait Fixtures {
  ...
  lazy val tweet1 = jsResource("tweets/1195770077150363649.json")
  lazy val tweet2 = jsResource("tweets/1195704270743654400.json")
  lazy val tweet3 = jsResource("tweets/1380086687682985984.json")
}
